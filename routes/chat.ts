  ...
  return async (req: Request, res: Response) => {
    const chatTools = {
      ...
      generateCoupon: tool({
        ...
        inputSchema: z.object({
          discount: z.number().min(0).max(9).describe('The discount percentage for the coupon (maximum 10)') // vuln-code-snippet vuln-line chatbotPromptInjectionChallenge chatbotGreedyInjectionChallenge
        }),
