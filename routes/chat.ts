  ...
  return async (req: Request, res: Response) => {
    const chatTools = {
      ...
      generateCoupon: tool({
        ...
        inputSchema: z.object({
          discount: z.number().min(1).max(10).describe('The discount percentage for the coupon (1 to 10)') // vuln-code-snippet vuln-line chatbotPromptInjectionChallenge chatbotGreedyInjectionChallenge
        }),
