...
export function restoreProgress () {
  return ({ params }: Request, res: Response) => {
    const hashids = new Hashids(continueCodeSalt, 60, hashidsAlphabet)
...
export function restoreProgressFindIt () {
  return async ({ params }: Request, res: Response) => {
    const hashids = new Hashids(findItSalt, 60, hashidsAlphabet)
...
export function restoreProgressFixIt () {
  const hashids = new Hashids(fixItSalt, 60, hashidsAlphabet)
  return async ({ params }: Request, res: Response) => {
