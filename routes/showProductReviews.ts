...
export function showProductReviews () {
  return (req: Request, res: Response, next: NextFunction) => {
    /* The review lookup no longer builds a '$where' clause, which the datastore executes as
       JavaScript. The id is matched as a plain field value, so nothing in the URL can be code. */
