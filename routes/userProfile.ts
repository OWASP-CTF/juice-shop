...
export function getUserProfile () {
  return async (req: Request, res: Response, next: NextFunction) => {
    ...
    // The username is never evaluated as an expression. Prefixing with a backslash stops
    // pug treating a #{...} sequence in it as interpolation, so it renders as literal text.
    ...
    try {
      ...
      // Static policy: interpolating the user-controlled profile image URL here allowed
      // an attacker to append their own directives, e.g. "; script-src 'unsafe-inline'".
