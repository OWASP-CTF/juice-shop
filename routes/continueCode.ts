...
export function continueCode () {
  const hashids = new Hashids(continueCodeSalts.challenges, 60, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890')
...
export function continueCodeFindIt () {
  const hashids = new Hashids(continueCodeSalts.findIt, 60, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890')
...
export function continueCodeFixIt () {
  const hashids = new Hashids(continueCodeSalts.fixIt, 60, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890')
  return async (req: Request, res: Response) => {
    const ids = []
