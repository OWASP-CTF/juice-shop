...
export function login () {
  ...
  function verifyPreLoginChallenges (req: Request) {
    challengeUtils.solveIf(challenges.weakPasswordChallenge, () => { return false })
    challengeUtils.solveIf(challenges.loginSupportChallenge, () => { return false })
    ...
    challengeUtils.solveIf(challenges.loginAmyChallenge, () => { return false })
