...
export function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query('SELECT * FROM Users WHERE email = $email AND password = $password AND deletedAt IS NULL', { model: UserModel, plain: true, bind: { email: req.body.email || '', password: security.hash(req.body.password || '') } })
