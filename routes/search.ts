...
export function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query(
        ...
        { replacements: { criteria: `%${criteria}%` } } // vuln-code-snippet neutral-line unionSqlInjectionChallenge dbSchemaChallenge
      ).then(([products]: any) => { // vuln-code-snippet neutral-line unionSqlInjectionChallenge dbSchemaChallenge
