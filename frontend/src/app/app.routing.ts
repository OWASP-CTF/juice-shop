...
const routes: Routes = [
  ...
  // The unreleased token sale page has been taken out of the application. It was reachable
  // only through an obfuscated path matcher, and an unguessable route is not access control.
  {
