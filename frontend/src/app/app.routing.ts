...
const routes: Routes = [
  ...
  // Development-only sandbox routes are intentionally not registered. // vuln-code-snippet vuln-line web3SandboxChallenge
  {
    path: 'chatbot',
  ...
  // Unreleased client routes are intentionally not registered. // vuln-code-snippet vuln-line tokenSaleChallenge
  {
