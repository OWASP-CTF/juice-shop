...
export const redirectAllowlist = new Set([
  ...
  /* The three cryptocurrency donation addresses that used to sit here were retired years ago.
     An allow-list entry is a standing permission to send customers somewhere, so an entry nobody
     owns any more is attack surface. */
...
export const isRedirectAllowed = (url: string) => {
  ...
  for (const allowedUrl of redirectAllowlist) {
    /* An allow-list is matched exactly. Asking only whether a permitted URL appears somewhere in
       the target lets an attacker keep it as a query parameter and redirect wherever they like. */
