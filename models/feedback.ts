  ...
  Feedback.init(
    {
      ...
      comment: {
        ...
        set (comment: string) {
          // Sanitize repeatedly until the output stops changing. A single pass is not
          // enough: "<<script>Foo</script>iframe src=..." collapses into a working
          // iframe tag once the inner script element is removed.
