  ...
  Product.init(
    {
      ...
      description: {
        ...
        set (description: string) {
          // Descriptions are rendered as HTML by the storefront, so they are sanitized on
          // write unconditionally. Previously this only happened when the API-only XSS
          // challenge was switched off, which left every REST client able to persist markup
          // the shop would later render.
