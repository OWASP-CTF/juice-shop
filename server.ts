...
function configureApp (app: ReturnType<typeof express>, seq: typeof sequelize) {
  ...
  app.put('/rest/continue-code-findIt/apply/:continueCode', security.isAuthorized(), utils.asyncHandler(restoreProgress.restoreProgressFindIt()))
  app.put('/rest/continue-code-fixIt/apply/:continueCode', security.isAuthorized(), utils.asyncHandler(restoreProgress.restoreProgressFixIt()))
  app.put('/rest/continue-code/apply/:continueCode', security.isAuthorized(), utils.asyncHandler(restoreProgress.restoreProgress()))
