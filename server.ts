...
function configureApp (app: ReturnType<typeof express>, seq: typeof sequelize) {
  ...
  app.get('/api/Recycles', security.appendUserId(), utils.asyncHandler(recycles.listOwnedRecycleItems()))
  app.post('/api/Recycles', security.isAuthorized(), security.appendUserId(), utils.asyncHandler(recycles.requireOwnedRecycleAddress()))
  /* Challenge evaluation before finale takes over */
  app.get('/api/Recycles/:id', security.appendUserId(), utils.asyncHandler(recycles.getOwnedRecycleItem()))
