...
function configureApp (app: ReturnType<typeof express>, seq: typeof sequelize) {
  ...
  app.use('/assets/public/images/padding/11px.png', restrictedBeacon((role) => role.length > 0))
  app.use('/assets/public/images/padding/56px.png', restrictedBeacon((role) => role.length > 0))
