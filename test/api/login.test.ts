...
void describe('/rest/user/login', () => {
  ...
  void it('POST login treats a WHERE-clause disabling payload as a literal, non-matching email', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login cannot bypass authentication for "admin@juice-sh.op" via SQL injection', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login cannot bypass authentication for "jim@juice-sh.op" via SQL injection', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login cannot bypass authentication for "bender@juice-sh.op" via SQL injection', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login cannot conjure up the non-existing "acc0unt4nt@juice-sh.op" user via a UNION SELECT injection attack', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login treats a query-breaking payload as a literal, non-matching email instead of erroring', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
