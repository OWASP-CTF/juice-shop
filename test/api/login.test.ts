...
void describe('/rest/user/login', () => {
  ...
  void it('POST login rejects SQL injection attack using known email "admin@juice-sh.op"', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login rejects SQL injection attack using known email "jim@juice-sh.op"', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login rejects SQL injection attack using known email "bender@juice-sh.op"', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login rejects UNION SELECT injection attack fabricating non-existing email "acc0unt4nt@juice-sh.op"', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
