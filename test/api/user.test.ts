...
void describe('/api/Users', () => {
  ...
  void it('POST new user requesting the admin role is created as a customer instead (mass assignment blocked)', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST new user requesting the deluxe role is created as a customer instead (mass assignment blocked)', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
  ...
  void it('POST new user requesting the accounting role is created as a customer instead (mass assignment blocked)', async () => {
    const res = await request(app)
      .post('/api/Users')
      .set(jsonHeader)
      .send({
