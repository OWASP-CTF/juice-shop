...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search does not leak a SQL error for a query-breaking payload', async () => {
    const res = await request(app)
  ...
  void it('GET product search cannot select the logically deleted christmas special by commenting out the where clause', async () => {
    const res = await request(app)
  ...
  void it('GET product search cannot select the logically deleted unsafe product by commenting out the where clause', async () => {
    const res = await request(app)
